...
public class Nim_game {
	...
	private static boolean canWin(int n) {
		...
		// because whenever you take 1, 2 or 3, your opponent can always take 3,
		// 2 or 1 and take the last stone.
		// but if the number can not be divided by 4, then you definitely win.
		//
		// let the number be 5 for example, at the first time, you take 1 stone,
		// and let the number of the left stones be divided by 4
